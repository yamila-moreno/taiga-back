...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for membership in orm.Membership.objects.filter(token__isnull=False):
            orm["invitations.ProjectInvitation"].objects.create(
                sender=membership.user, recipient_email=membership.email,
                token=membership.token, project=membership.project,
    ...
    models = {
        ...
        'projects.membership': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']", 'related_name': "'memberships'", 'blank': 'True', 'default': 'None', 'null': 'True'})
        },
        'projects.points': {
        ...
        'projects.project': {
            ...
            'creation_template': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.ProjectTemplate']", 'related_name': "'projects'", 'blank': 'True', 'default': 'None', 'null': 'True'}),
            'default_issue_status': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'unique': 'True', 'related_name': "'+'", 'to': "orm['projects.IssueStatus']"}),
            'default_issue_type': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'unique': 'True', 'related_name': "'+'", 'to': "orm['projects.IssueType']"}),
            'default_points': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'unique': 'True', 'related_name': "'+'", 'to': "orm['projects.Points']"}),
            'default_priority': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'unique': 'True', 'related_name': "'+'", 'to': "orm['projects.Priority']"}),
            'default_severity': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'unique': 'True', 'related_name': "'+'", 'to': "orm['projects.Severity']"}),
            'default_task_status': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'unique': 'True', 'related_name': "'+'", 'to': "orm['projects.TaskStatus']"}),
            'default_us_status': ('django.db.models.fields.related.OneToOneField', [], {'on_delete': 'models.SET_NULL', 'blank': 'True', 'null': 'True', 'unique': 'True', 'related_name': "'+'", 'to': "orm['projects.UserStoryStatus']"}),
        ...
        'users.user': {
            ...
            'color': ('django.db.models.fields.CharField', [], {'blank': 'True', 'default': "'#771675'", 'max_length': '9'}),
