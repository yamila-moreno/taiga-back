...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invitations_projectinvitation', (
        ...
        db.send_create_signal('invitations', ['ProjectInvitation'])

        # Adding unique constraint on 'ProjectInvitation', fields ['recipient_email', 'project']
        db.create_unique('invitations_projectinvitation', ['recipient_email', 'project_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectInvitation', fields ['recipient_email', 'project']
        db.delete_unique('invitations_projectinvitation', ['recipient_email', 'project_id'])

        # Deleting model 'ProjectInvitation'
        db.delete_table('invitations_projectinvitation')
    ...
    models = {
        ...
        'invitations.projectinvitation': {
            'Meta': {'unique_together': "(('recipient_email', 'project'),)", 'object_name': 'ProjectInvitation', 'ordering': "['-created_at']"},
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.User']"}),
        ...
        'projects.membership': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'memberships'", 'blank': 'True', 'to': "orm['users.User']", 'null': 'True'})
        },
        'projects.points': {
        ...
        'projects.project': {
            ...
            'creation_template': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'projects'", 'blank': 'True', 'to': "orm['projects.ProjectTemplate']", 'null': 'True'}),
            'default_issue_status': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['projects.IssueStatus']", 'null': 'True', 'unique': 'True', 'on_delete': 'models.SET_NULL'}),
            'default_issue_type': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['projects.IssueType']", 'null': 'True', 'unique': 'True', 'on_delete': 'models.SET_NULL'}),
            'default_points': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['projects.Points']", 'null': 'True', 'unique': 'True', 'on_delete': 'models.SET_NULL'}),
            'default_priority': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['projects.Priority']", 'null': 'True', 'unique': 'True', 'on_delete': 'models.SET_NULL'}),
            'default_severity': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['projects.Severity']", 'null': 'True', 'unique': 'True', 'on_delete': 'models.SET_NULL'}),
            'default_task_status': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['projects.TaskStatus']", 'null': 'True', 'unique': 'True', 'on_delete': 'models.SET_NULL'}),
            'default_us_status': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'+'", 'blank': 'True', 'to': "orm['projects.UserStoryStatus']", 'null': 'True', 'unique': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        'users.user': {
            ...
            'color': ('django.db.models.fields.CharField', [], {'default': "'#1eacb8'", 'blank': 'True', 'max_length': '9'}),
